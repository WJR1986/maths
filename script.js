...
const takeAnotherTestButton = document.getElementById("take-another-test-button");
...
function startTest() {
  ...
  document.getElementById("sub-subject-buttons-container").style.display = "none";
...
console.log("Before adding event listener to startButton:", startButton);
...
console.log("After adding event listener to startButton:", startButton);
...
function displayQuestion(index) {
  if (index < questions.length) {
    ...
    // Add the "working-textarea" for showing working
...
submitAnswerButton.addEventListener("click", () => {
  ...
  const answerValidationMessage = document.getElementById("answer-validation-message");
  ...
  if (selectedOption) {
    ...
    // Add a class to the textarea based on correctness
    if (isCorrect) {
    ...
    answerValidationMessage.textContent = "Please select an answer before submitting.";
...
function displayUserAnswersAndDescriptions() {
  ...
  const quizFormContainer = document.getElementById("quiz-form-container");
  quizFormContainer.insertBefore(userScoreElement, quizFormContainer.firstChild);
}
...
function handleFormSubmission() {
  ...
  const customSubmissionPage = document.getElementById("custom-submission-page");
